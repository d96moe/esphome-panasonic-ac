...
// 19 keys: 17 standard + 0x85 (4-byte counter) + 0x88 (1-byte status).
// length field (byte 3): 0x3E = 62 = (66 array bytes - 4 header bytes).
// count field (byte 8): 0x13 = 19.
// Expected response: 136 bytes (125 standard + 1 trailing for 0x86 + 7 for 0x85 + 3 for 0x88).
static const uint8_t CMD_POLL[]{0x10, 0x09, 0x00, 0x3E, 0x01, 0x01, 0x30, 0x01, 0x13, 0x00, 0x80, 0x00,
